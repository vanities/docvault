...
export const logQuant = createLogger('Quant');
...
export async function saveCache(cache: QuantCache): Promise<void> {
  await fs.writeFile(QUANT_CACHE_FILE, JSON.stringify(cache, null, 2));
}

export function isFresh(entry: CacheEntry<unknown> | undefined, ttl: number): boolean {
...
export async function readSnapshots(): Promise<QuantSnapshotsFile> {
  try {
...
export async function computePresidentialCycle(): Promise<PresidentialCycleResponse> {
...
export async function computeBtcLogRegression(): Promise<BtcLogRegressionResponse> {
...
export async function computeAltcoinSeasonIndex(): Promise<AltcoinSeasonResponse> {
...
export async function computeBtcDerivatives(): Promise<BtcDerivativesResponse> {
...
export async function fetchBtcDominance(): Promise<DominanceSnapshot> {
...
export async function computeSectorRotation(): Promise<SectorRotationResponse> {
...
export async function computeSP500RiskMetric(): Promise<SP500RiskResponse> {
  const rows = await fetchShillerFull();
  if (rows.length < 240) {
...
export async function computeMidtermDrawdowns(): Promise<MidtermDrawdownResponse> {
  const rows = await fetchShillerFull();
  if (rows.length < 240) {
    throw new Error(`Insufficient Shiller history (got ${rows.length} rows)`);
  }
...
export async function computeShillerValuation(): Promise<ShillerValuationResponse> {
  const rows = await fetchShillerFull();
  if (rows.length < 120) {
    throw new Error(`Insufficient Shiller history (got ${rows.length} rows)`);
  }
...
export async function computeMacroDashboard(apiKey: string): Promise<MacroDashboardResponse> {
  return computeMacroSeriesList(apiKey, MACRO_SERIES);
}

export async function computeJobsDashboard(apiKey: string): Promise<MacroDashboardResponse> {
  return computeMacroSeriesList(apiKey, JOBS_SERIES);
}

export async function computeBusinessCycle(apiKey: string): Promise<MacroDashboardResponse> {
  return computeMacroSeriesList(apiKey, BUSINESS_CYCLE_SERIES);
}

export async function computeInflationDashboard(apiKey: string): Promise<MacroDashboardResponse> {
  return computeMacroSeriesList(apiKey, INFLATION_SERIES);
}

export async function computeFinancialConditions(apiKey: string): Promise<MacroDashboardResponse> {
  return computeMacroSeriesList(apiKey, FINANCIAL_CONDITIONS_SERIES);
}

export async function computeHousingDashboard(apiKey: string): Promise<MacroDashboardResponse> {
  return computeMacroSeriesList(apiKey, HOUSING_SERIES);
}

export async function computeGdpGrowthDashboard(apiKey: string): Promise<MacroDashboardResponse> {
...
export async function computeCommodities(): Promise<MacroDashboardResponse> {
  return computeYahooDashboard(COMMODITIES_SERIES, '2000-01-01');
}

export async function computeVixTermStructure(): Promise<MacroDashboardResponse> {
...
export async function computeGlobalMarkets(): Promise<MacroDashboardResponse> {
...
export async function computeBtcDrawdown(): Promise<BtcDrawdownResponse> {
  const prices = await fetchBtcHistory();
  if (prices.length < 30) {
    throw new Error(`Insufficient BTC history (got ${prices.length} points)`);
  }
...
export async function computeFearGreed(): Promise<FearGreedResponse> {
...
export async function computeKronos(): Promise<KronosForecastResponse> {
...
export async function computeFlippening(): Promise<FlippeningResponse> {
...
export async function computeRealRates(apiKey: string): Promise<RealRatesResponse> {
...
export async function computeRunningRoi(): Promise<RunningRoiResponse> {
...
export async function computeHashRate(): Promise<HashRateResponse> {
...
export async function computeYieldCurve(apiKey: string): Promise<YieldCurveResponse> {
