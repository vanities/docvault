...
# Benjamin Cowen posts regular uploads (/videos) AND live streams (/streams),
# which YouTube lists on separate tabs. Scrape both; the dedup below merges them
# so a video shown on multiple tabs is filed only once.
SOURCE_URLS=(
  "https://www.youtube.com/channel/UCRvqjQPSeaWn-uEx-w0XOIg/videos"
  "https://www.youtube.com/channel/UCRvqjQPSeaWn-uEx-w0XOIg/streams"
)
DOMAIN="finance"
