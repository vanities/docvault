  ...
  if (isLoading) {
    return (
      <div className="max-w-5xl mx-auto px-4 md:px-6 py-8">
        <h2 className="font-display italic text-2xl text-surface-950 mb-6">Portfolio Overview</h2>
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 md:px-6 py-8">
      ...
      <div className="flex flex-wrap items-center justify-between gap-3 mb-8">
        <div>
          <h2 className="font-display italic text-2xl text-surface-950">Portfolio Overview</h2>
          {lastUpdated && (
