/**
 * File naming utilities following the naming convention ({Source}_{Type}_{Date}.ext)
...
/**
 * Generate a standardized filename following the naming convention ({Source}_{Type}_{Date}.ext)
 */
